...
const tty = __webpack_require__(7);
...
var buildURL = __webpack_require__(1);
var buildFullPath = __webpack_require__(13);
...
var _ArgumentError2 = __webpack_require__(113);
...
var _SigningKeyNotFoundError2 = __webpack_require__(71);
...
const cookie_1 = __webpack_require__(51);
const axios_1 = __importDefault(__webpack_require__(20));
const https_1 = __webpack_require__(3);
const template_html_1 = __importDefault(__webpack_require__(52));
...
function getCompleteConfig() {
    ...
    const cookieSettings = config.cookieSettings ? Object.fromEntries(Object
        .entries({ ...defaultCookieSettings, ...config.cookieSettings })
        .map(([k, v]) => [k, v || defaultCookieSettings[k]])) : defaultCookieSettings;
    // Defaults for nonce and PKCE
    const defaults = {
        secretAllowedCharacters: 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~',
        pkceLength: 43,
        nonceLength: 16,
        nonceMaxAge: (cookieSettings === null || cookieSettings === void 0 ? void 0 : cookieSettings.nonce) && parseInt(cookie_1.parse(cookieSettings.nonce.toLowerCase())['max-age']) || 60 * 60 * 24,
    };
    return {
        ...defaults,
        ...config,
...
function sign(stringToSign, secret, signatureLength) {
    const digest = crypto_1.createHmac('sha256', secret).update(stringToSign).digest('base64').slice(0, signatureLength);
...
/*global exports*/
var SignStream = __webpack_require__(79);
var VerifyStream = __webpack_require__(83);
...
module.exports = {
  ...
  verify: __webpack_require__(84),
  sign: __webpack_require__(87),
  JsonWebTokenError: __webpack_require__(54),
  NotBeforeError: __webpack_require__(64),
  TokenExpiredError: __webpack_require__(65),
};
...
var jws = __webpack_require__(57);
...
var bufferEqual = __webpack_require__(80);
var Buffer = __webpack_require__(47).Buffer;
var crypto = __webpack_require__(46);
var formatEcdsa = __webpack_require__(81);
var util = __webpack_require__(4);
...
var JsonWebTokenError = __webpack_require__(54);
...
var Yallist = __webpack_require__(106)
...
const jwks_rsa_1 = __importDefault(__webpack_require__(95));
...
async function validate(jwtToken, jwksUri, issuer, audience, targetState) {
    ...
    return new Promise((resolve, reject) => jsonwebtoken_1.verify(jwtToken, jwk, verificationOptions, (err) => err ? reject(err) : resolve()));
}
...
/*global module*/
var Buffer = __webpack_require__(47).Buffer;
var DataStream = __webpack_require__(61);
var jwa = __webpack_require__(62);
var Stream = __webpack_require__(18);
...
var Buffer = __webpack_require__(53).Buffer; // browserify
var SlowBuffer = __webpack_require__(53).SlowBuffer;
...
var getParamBytesForAlg = __webpack_require__(82);
...
var JsonWebTokenError = __webpack_require__(54);
var NotBeforeError    = __webpack_require__(64);
var TokenExpiredError = __webpack_require__(65);
var decode            = __webpack_require__(60);
var timespan          = __webpack_require__(66);
var PS_SUPPORTED      = __webpack_require__(67);
var jws               = __webpack_require__(57);
...
var PS_SUPPORTED = __webpack_require__(67);
var jws = __webpack_require__(57);
var includes = __webpack_require__(88);
var isBoolean = __webpack_require__(89);
var isInteger = __webpack_require__(90);
var isNumber = __webpack_require__(91);
var isPlainObject = __webpack_require__(92);
var isString = __webpack_require__(93);
...
var _JwksClient = __webpack_require__(48);

var _errors = __webpack_require__(49);

var errors = _interopRequireWildcard(_errors);

var _hapi = __webpack_require__(114);

var _express = __webpack_require__(115);

var _koa = __webpack_require__(116);
...
try {
	...
	const supportsColor = __webpack_require__(21);
...
exports.default = function (options, cb) {
  ...
  if (options.agentOptions || options.strictSSL != undefined) {
    var agentOptions = _extends({}, options.strictSSL != undefined && { rejectUnauthorized: options.strictSSL }, options.agentOptions);
...
var _cache = __webpack_require__(101);

var _cache2 = _interopRequireDefault(_cache);

var _rateLimit = __webpack_require__(109);
...
var _ms = __webpack_require__(69);
...
var _lruMemoizer = __webpack_require__(102);
...
Object.defineProperty(exports, "__esModule", { value: true });
var lru_cache_1 = __importDefault(__webpack_require__(72));
var events_1 = __webpack_require__(73);
var lodash_clonedeep_1 = __importDefault(__webpack_require__(74));
var freeze_1 = __webpack_require__(75);
var sync_1 = __webpack_require__(108);
...
var _limiter = __webpack_require__(110);
...
exports.RateLimiter = __webpack_require__(111);
exports.TokenBucket = __webpack_require__(76);
...
var TokenBucket = __webpack_require__(76);
var getMilliseconds = __webpack_require__(112);
...
const querystring_1 = __webpack_require__(56);
const crypto_1 = __webpack_require__(46);
const validate_jwt_1 = __webpack_require__(78);
...
exports.handler = async (event) => {
    ...
    //const state = request.headers['referer'][0].value;
    //const redirectedState = state.substring(state.lastIndexOf("redirect_uri=https%3A%2F%2F") + 27, state.lastIndexOf(".goatfield.us"));
    const domainName = request.headers['host'][0].value;
    const requestedUri = `${request.uri}${request.querystring ? '?' + request.querystring : ''}`;
    try {
        const { idToken, refreshToken, nonce, nonceHmac } = shared_1.extractAndParseCookies(request.headers, CONFIG.clientId, CONFIG.cookieCompatibility);
        ...
        const { exp } = shared_1.decodeToken(idToken);
        ...
        if ((Date.now() / 1000) > exp - (60 * 10) && refreshToken) {
            ...
            const response = {
                ...
                headers: {
                    'location': [{
                            key: 'location',
                            value: `https://${domainName}${CONFIG.redirectPathAuthRefresh}?${querystring_1.stringify({ requestedUri, nonce })}`
                        }],
                    'set-cookie': [
                        { key: 'set-cookie', value: `spa-auth-edge-nonce=${encodeURIComponent(nonce)}; ${CONFIG.cookieSettings.nonce}` },
                        { key: 'set-cookie', value: `spa-auth-edge-nonce-hmac=${encodeURIComponent(shared_1.sign(nonce, CONFIG.nonceSigningSecret, CONFIG.nonceLength))}; ${CONFIG.cookieSettings.nonce}` },
                    ],
        ...
        await validate_jwt_1.validate(idToken, CONFIG.tokenJwksUri, CONFIG.tokenIssuer, CONFIG.clientId, domainName.split(".")[0]);
        ...
        const state = {
            nonce,
            nonceHmac: shared_1.sign(nonce, CONFIG.nonceSigningSecret, CONFIG.nonceLength),
        ...
        const loginQueryString = querystring_1.stringify({
            redirect_uri: `https://${domainName}${CONFIG.redirectPathSignIn}`,
            response_type: 'code',
            client_id: CONFIG.clientId,
            state: shared_1.urlSafe.stringify(Buffer.from(JSON.stringify({ nonce: state.nonce, requestedUri })).toString('base64')),
...
function generatePkceVerifier(pkce) {
    ...
    const verifier = {
        pkce,
        pkceHash: shared_1.urlSafe.stringify(crypto_1.createHash('sha256')
            .update(pkce, 'utf8')
            .digest('base64')),
    };
...
function generateNonce() {
    ...
    const nonce = `${shared_1.timestampInSeconds()}T${randomString}`;
...
function randomChoiceFromIndexable(indexable) {
    ...
    let randomNumber;
    do {
        randomNumber = crypto_1.randomBytes(1)[0];
